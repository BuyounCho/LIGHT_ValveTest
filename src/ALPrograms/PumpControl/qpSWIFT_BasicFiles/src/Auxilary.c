...
*
* Contains function implementations decalred in Prime.h
*
*
*********************************************************************************************************/
...
/*!
 * @brief Assembles the KKT matrix when inequality constraints don't exist
 *
 * @param[out] kkt   KKT Matrix
 * @param[in]  P     Cost Function Matrix
 * @param[in]  A     Equality Constraint Matrix
...
void formkktmatrix_NoInequ(smat *P, smat *A, smat *At, smat *kkt) {
 ...
 *
 * @param[out] Flag         Primal step length
...
/*!
 * @brief  Calcualtes the Eucledian two norm of vector
 *
...
/*!
 * @brief  Calcualtes the inner product of two vectors
 *
 ...
 *
 * @param[out] Flag         Flag indicating status of the function
...
/*!
 * @brief  Performs Sparse Matrix Trasnpose Vector Multiplication as
 *
