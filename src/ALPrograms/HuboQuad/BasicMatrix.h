...
public:
	...
	vec3(const double* v);
        ...
        void print(std::string name){std::cout<<name<<": "<<x<<" "<<y<<" "<<z<<std::endl;}
};
...
inline mat4::mat4(const vec3_& offset,const mat3_& m){
    m00 = m.m00; m01 = m.m01; m02 = m.m02; m03 = offset.x;
    m10 = m.m10; m11 = m.m11; m12 = m.m12; m13 = offset.y;
    m20 = m.m20; m21 = m.m21; m22 = m.m22; m23 = offset.z;
    m30 =     0; m31 =     0; m32 =     0; m33 = 1;
}
