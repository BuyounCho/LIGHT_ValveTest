...
int MCJointPWMCommand2chHR(unsigned int _canch, unsigned int _bno, int mode1, short duty1, int mode2, short duty2)
{
    ...
    MCData.data[1] = mode1;
    MCData.data[2] = (unsigned char)(duty1 & 0x00FF);
    MCData.data[3] = (unsigned char)((duty1>>8) & 0x00FF);
    MCData.data[4] = mode2;
    MCData.data[5] = (unsigned char)(duty2 & 0x00FF);
    MCData.data[6] = (unsigned char)((duty2>>8) & 0x00FF);
