...
void MoveQJ(QuadJoints _QJ,double ms)
{
    ...
    jCon->SetMoveJoint(RHP,_QJ.RHP*R2Df,ms,MOVE_ABSOLUTE);
    ...
    jCon->SetMoveJoint(LHP,_QJ.LHP*R2Df,ms,MOVE_ABSOLUTE);
    ...
    jCon->SetMoveJoint(RSP,_QJ.RSP*R2Df,ms,MOVE_ABSOLUTE);
    ...
    jCon->SetMoveJoint(LSP,_QJ.LSP*R2Df,ms,MOVE_ABSOLUTE);
    jCon->SetMoveJoint(LEB,Oii.q2m_kn(_QJ.LEB)*R2Df,ms,MOVE_ABSOLUTE);

    cout << "_QJ.RHR = " << _QJ.RHR*R2Df << ", _QJ.RHP = " << _QJ.RHP*R2Df << ", _QJ.RKN = " << _QJ.RKN*R2Df << endl;
    cout << "_QJ.LHR = " << _QJ.LHR*R2Df << ", _QJ.LHP = " << _QJ.LHP*R2Df << ", _QJ.LKN = " << _QJ.LKN*R2Df << endl;
    cout << "_QJ.RSR = " << _QJ.RSR*R2Df << ", _QJ.RSP = " << _QJ.RSP*R2Df << ", _QJ.REB = " << _QJ.REB*R2Df << endl;
    cout << "_QJ.LSR = " << _QJ.LSR*R2Df << ", _QJ.LSP = " << _QJ.LSP*R2Df << ", _QJ.LEB = " << _QJ.LEB*R2Df << endl;
    cout <<"_QJ.LEB2 = " << Oii.m2q_kn((Oii.q2m_kn(_QJ.LEB)))*R2Df<<endl;

//    double q = _QJ.RKN;
//    double m_kn = Oii.q2m_kn(q);
//    cout << "q = " << q << ", m_kn [rad] = " << m_kn << ", m_kn [deg] = " << m_kn*R2Df << endl;
//    cout << "q2m_kn(_QJ.RKN) = " << Oii.q2m_kn(_QJ.RKN)*R2Df << ", q2m_kn(_QJ.LKN) = " << Oii.q2m_kn(_QJ.LKN)*R2Df << ", q2m_kn(_QJ.REB) = " << Oii.q2m_kn(_QJ.REB)*R2Df << ", q2m_kn(_QJ.LEB) = " << Oii.q2m_kn(_QJ.LEB)*R2Df << endl;
}
void SetRef(QuadJoints _QJ)
{
    jCon->SetJointRefAngle(RHR,Oii.q2m_rhr(_QJ.RHR)*R2Df);
    jCon->SetJointRefAngle(RHP,_QJ.RHP*R2Df);
    jCon->SetJointRefAngle(RKN,Oii.q2m_kn(_QJ.RKN)*R2Df);

    jCon->SetJointRefAngle(LHR,Oii.q2m_lhr(_QJ.LHR)*R2Df);
    jCon->SetJointRefAngle(LHP,_QJ.LHP*R2Df);
    jCon->SetJointRefAngle(LKN,Oii.q2m_kn(_QJ.LKN)*R2Df);

    jCon->SetJointRefAngle(RSR,Oii.q2m_rhr(_QJ.RSR)*R2Df);
    jCon->SetJointRefAngle(RSP,_QJ.RSP*R2Df);
    jCon->SetJointRefAngle(REB,Oii.q2m_kn(_QJ.REB)*R2Df);

    jCon->SetJointRefAngle(LSR,Oii.q2m_lhr(_QJ.LSR)*R2Df);
    jCon->SetJointRefAngle(LSP,_QJ.LSP*R2Df);
...
//                jCon->SetMoveJoint(LEB, 0.0, mtime, MOVE_ABSOLUTE);
                ...
                jCon->SetMoveJoint(RHP, 0.0, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(RKN, Oii.q2m_kn(-90.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(LHR, Oii.q2m_lhr(0.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LHP, 0.0, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LKN, Oii.q2m_kn(-90.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(RSR, Oii.q2m_rhr(0.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(RSP, 0.0, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(REB, Oii.q2m_kn(-90.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(LSR, Oii.q2m_lhr(0.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LSP, 0.0, mtime, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LEB, Oii.q2m_kn(-90.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
...
//                    jCon->SetMoveJoint(LEB, (0-40*mscale), mtime, MOVE_ABSOLUTE);
                    ...
                    jCon->SetMoveJoint(RHP, (50+25*mscale), mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(RKN, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                    jCon->SetMoveJoint(LHR, Oii.q2m_lhr(10.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(LHP, (50+25*mscale), mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(LKN, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                    jCon->SetMoveJoint(RSR, Oii.q2m_rhr(-10.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(RSP, (50+25*mscale), mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(REB, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);

                    jCon->SetMoveJoint(LSR, Oii.q2m_lhr(10.0*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(LSP, (50+25*mscale), mtime, MOVE_ABSOLUTE);
                    jCon->SetMoveJoint(LEB, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, mtime, MOVE_ABSOLUTE);
                    usleep(mtime*1000);
...
//                jCon->SetMoveJoint(LEB, (0-40*mscale), 2000, MOVE_ABSOLUTE);
                ...
                jCon->SetMoveJoint(RHP, (50+25*mscale), 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(RKN, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(LHR, Oii.q2m_lhr(10.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LHP, (50+25*mscale), 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LKN, Oii.q2m_kn((0-130.0*mscale)*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                usleep(2000*1000);
...
//                jCon->SetMoveJoint(LEB, 0.0, 2000, MOVE_ABSOLUTE);
                ...
                jCon->SetMoveJoint(RHP, 50.0, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(RKN, Oii.q2m_kn(-90.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(LHR, Oii.q2m_lhr(5.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LHP, 50.0, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LKN, Oii.q2m_kn(-90.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(RSR, Oii.q2m_rhr(-5.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(RSP, 50.0, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(REB, Oii.q2m_kn(-90.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);

                jCon->SetMoveJoint(LSR, Oii.q2m_lhr(5.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LSP, 50.0, 2000, MOVE_ABSOLUTE);
                jCon->SetMoveJoint(LEB, Oii.q2m_kn(-90.0*D2Rf)*R2Df, 2000, MOVE_ABSOLUTE);
                usleep(2000*1000);
            }
            sharedCMD->COMMAND[PODO_NO].USER_COMMAND = NO_ACT;
            break;
        ...
        case PERFORMANCE_TEST_COM_PELVIS_READY:
        {
            /*
            double q = -90.0;
            double m_kn = Oii.q2m_kn(q*D2Rf);
            cout << "q = " << q << ", m_kn [rad] = " << m_kn << ", m_kn [deg] = " << m_kn*R2Df << endl;
            double q2 = -45.0;
            double m_kn2 = Oii.q2m_kn(q2*D2Rf);
            cout << "q2 = " << q2 << ", m_kn [rad] = " << m_kn2 << ", m_kn [deg] = " << m_kn2*R2Df << endl;
//            double m_lhr = Oii.q2m_lhr(q*D2Rf)*R2Df;
//            double m_rhr = Oii.q2m_rhr(q*D2Rf)*R2Df;
//            double m_kn = Oii.q2m_kn(q*D2Rf)*R2Df;
//            double q_lhr = Oii.m2q_lhr(m_lhr*D2Rf)*R2Df;
//            double q_rhr = Oii.m2q_rhr(m_rhr*D2Rf)*R2Df;
//            double q_kn = Oii.m2q_kn(m_kn*D2Rf)*R2Df;
//            cout << "q = " << q << ", q_lhr = " << q_lhr << ", q_rhr = " << q_rhr << ", q_kn = " << q_kn << endl;
            */
            FILE_LOG(logSUCCESS) << "Command PERFORMANCE_TEST_COM_PELVIS_READY received..";
            jCon->RefreshToCurrentReference();
            jCon->SetAllMotionOwner();

            double comz = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[0];
            double time = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[1];
...
//            printf("pCOM %f %f %f\n",QP.pCOM.x,QP.pCOM.y,QP.pCOM.z);
        ...
        case PERFORMANCE_TEST_COM_PELVIS_MOTION:
        {
            FILE_LOG(logSUCCESS) << "Command PERFORMANCE_TEST_COM_PELVIS_MOTION received..";
            jCon->RefreshToCurrentReference();
            jCon->SetAllMotionOwner();

            double comx = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[0];
            double comy = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[1];
            double comz = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[2];
            double pelr = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[3];
            double pelp = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[4];
            double pely = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[5];
            double time = sharedCMD->COMMAND[PODO_NO].USER_PARA_DOUBLE[6];

//            mat3 rot = mat3(vec3(-1,0,0),pelr*D2Rf)*mat3(vec3(0,-1,0),pelp*D2Rf)*mat3(vec3(0,0,-1),pely*D2Rf); //RPY
//            QP.qPel = quat(rot);
            QP.qPel = quat(mat3(rpy(pelr*D2Rf,pelp*D2Rf,pely*D2Rf)));
            QJ = Oi.IK_pel(QP);
            QP = Oi.FK(QJ);
            printf("pRF %f %f %f\n",QP.pRF.x,QP.pRF.y,QP.pRF.z);
            printf("pLF %f %f %f\n",QP.pLF.x,QP.pLF.y,QP.pLF.z);
