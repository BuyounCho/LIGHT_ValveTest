            ...
            while(fog->RBGetReceivedDataByte(&rcv) == 1){
                ...
                case 4:
                    ...
                    if(cnt == 32){
                        ...
                        if(std::isnan(delX) == true){
                            FILE_LOG(logWARNING) << "FOG nan value";
                            delX = 0.;
                        }
                        if(std::isnan(delY) == true){
                            FILE_LOG(logWARNING) << "FOG nan value";
                            delY = 0.;
                        }
                        if(std::isnan(delZ) == true){
                            FILE_LOG(logWARNING) << "FOG nan value";
                            delZ = 0.;
                        }
                        ...
                        if(std::isnan(fog->FOGPitch) == true){
                            FILE_LOG(logWARNING) << "FOG nan value";
                            fog->FOGPitch = 0.;
                        }
                        if(std::isnan(fog->FOGRoll) == true){
                            FILE_LOG(logWARNING) << "FOG nan value";
                            fog->FOGRoll = 0.;
                        }
