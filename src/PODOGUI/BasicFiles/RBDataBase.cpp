...
//            _DB_VC[i].BOARD_TYPE        = query.value(2).toInt();
//            _DB_VC[i].MOTOR_CHANNEL     = _DB_VC[i].BOARD_TYPE;
//            _DB_VC[i].CAN_CHANNEL       = query.value(3).toInt();
//            _DB_VC[i].ID_SEND_REF       = query.value(4).toInt();
//            _DB_VC[i].ID_RCV_ENC        = query.value(5).toInt();
//            _DB_VC[i].ID_RCV_STAT       = query.value(6).toInt();
//            _DB_VC[i].ID_RCV_INFO       = query.value(7).toInt();
//            _DB_VC[i].ID_RCV_PARA       = query.value(8).toInt();
//            _DB_VC[i].ID_SEND_GENERAL   = query.value(9).toInt();

//            for(int j=0; j<MAX_JOINT; j++){
//                _DB_VC[i].JOINTS[j].HARMONIC = query.value(10+j*6).toDouble();
//                _DB_VC[i].JOINTS[j].PULLY_DRIVE = query.value(11+j*6).toDouble();
//                _DB_VC[i].JOINTS[j].PULLY_DRIVEN = query.value(12+j*6).toDouble();
//                _DB_VC[i].JOINTS[j].ENCODER_RESOLUTION = query.value(13+j*6).toDouble();
//                _DB_VC[i].JOINTS[j].PPR = _DB_VC[i].JOINTS[j].HARMONIC * _DB_VC[i].JOINTS[j].PULLY_DRIVEN / _DB_VC[i].JOINTS[j].PULLY_DRIVE * _DB_VC[i].JOINTS[j].ENCODER_RESOLUTION / 360.0;
//                _DB_VC[i].JOINTS[j].FRIC_PARAM1 = query.value(14+j*6).toDouble();
//                _DB_VC[i].JOINTS[j].FRIC_PARAM2 = query.value(15+j*6).toDouble();
//            }
        }
    }
...
//            _DB_IMU[i].SENSOR_ID                = query.value(3).toInt();
