...
private slots:
    ...
    void on_TW_4_itemSelectionChanged();

    void on_TW_5_itemSelectionChanged();

    void on_TW_6_itemSelectionChanged();

    void on_BTN_SET_CURRENT_clicked();

    void on_BTN_SET_PWM_clicked();

    void on_BTN_COCOA_REQUEST_EVERYTING_clicked();

    void on_RB_Pcon_clicked();

    void on_RB_Ccon_clicked();

    void on_RB_Acon_clicked();

    void on_BTN_COCOA_GAIN_SET_clicked();

    void on_BTN_COCOA_SET_DIRECTION_clicked();

    void on_BTN_COCOA_FINDHOME_SET_clicked();

    void on_BTN_COCOA_FINDHOME_SET_2_clicked();

    void on_BTN_COCOA_PWMRATE_LIM_SET_clicked();

    void on_BTN_COCOA_PWMRATE_LIM_SET_2_clicked();

    void on_BTN_COCOA_INTERNAL_POSITION_GOTO_clicked();
