...
//    QFrame           *frameMODEL;
    ...
    // User Dialog
    QuadSettingDialog                   *dialogQuadSetting;
    HCBSettingDialog                    *dialogHCBSetting;
    PumpControlDialog                   *dialogPumpControl;
    LIGHTWalkingDialog                  *dialogLIGHTWalking;
    LIGHTWalkingDialog2                 *dialogLIGHTWalking2;
    LIGHTWalkingDialog_GainSetting      *dialogLIGHTWalking_GainSetting;
    SH_TASK_Dialog                      *dialogSH_TASK;
    ValvePerfTest_Dialog                *dialogValvePerfTest;

//    PerformanceTestDialog *dialogPerformanceTest;
//    HuboQuadDialog *dialogHuboQuad;
//    hqdialog_threadmill *dialogHQ;
//    JumpDialog        *dialogJUMP;

    QIcon icon_LAN_ON, icon_LAN_OFF;
    QIcon icon_Module, icon_Joint, icon_Sensor;
